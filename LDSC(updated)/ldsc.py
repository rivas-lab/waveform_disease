...
import ldscore.ldsc_parse as ps
...
#         '''
#         # print(msg.decode() if isinstance(msg, bytes) else msg, file=self.log_fh)
#         print(str(msg), file=self.log_fh)
#         print(msg)
...
class Logger(object):
    '''
    Lightweight logging.
    Logging module version of original.
    '''
    def __init__(self, fh):
        self.logger = logging.getLogger('ldsc_logger')
        ...
        # File handler
        file_handler = logging.FileHandler(fh, mode='w')  # text mode
